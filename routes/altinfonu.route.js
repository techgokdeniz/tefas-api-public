 ...
 * /altinfonu:
 *    get:
 *     summary: Tüm altın fonlarını listeler
 *     tags: [Fon Listesi]
 *     responses:
 *      '200':
 *        description: tüm altın fonlarını listeler
 */
      ...
      (err, response) => {
        ...
        request(
          ...
          (err, response) => {
            ...
            let altinfonlari = parsedjson.data.filter(
              (item) => item["FONTURACIKLAMA"] == "Altın Fonu"
            );

            res.json({
              fonsayisi: altinfonlari.length,
              fonlar: altinfonlari,
            });
          }
        );
